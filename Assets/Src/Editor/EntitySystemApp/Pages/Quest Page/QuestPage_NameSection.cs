...
public class QuestPage_NameSection : SectionBase<Quest> {

    public QuestPage_NameSection(float spacing) : base(spacing) {}
    ...
    public override void Render() {
        ...
        GUILayout.Space(20f);
        EditorGUILayoutX.PropertyField(id, new GUIContent("Quest Name"), true);
        GUILayout.BeginHorizontal();
